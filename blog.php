                           ...
                           <!-- <ul class="dropdown-menu">
							...
							<li class="dropdown">
								...
								<ul class="dropdown-menu">
									...
									<li><a href="about-us2.html">Hospital Events</a></li>
								</ul>
							</li>
							...
							<li class="dropdown">
								<a href="#" class="dropdown-toggle" ><i
										class="fa fa-plus"></i>Career</a>
								<ul class="dropdown-menu">
									<li><a href="about-us.html">Internships</a></li>
									<li><a href="about-us2.html">Job opportunities</a></li>
								</ul>
							</li>
			...
			<div class="row" >
				...
				<div class="col-md-2 ">
					...
					<!-- <div class="col-md-3">
						...
						<a href="#">
							<p  class="quick-links-items"><i class="fa fa-long-arrow-right"  ></i>Career</p>
						</a>
               ...
               <li><a href="https://www.facebook.com/profile.php?id=100063949147300" ><i class="fab fa-facebook-f" style="color: #eca328;"></i></a></li>								
								<li><a href="https://www.youtube.com/@Drsolankieyehospital2024"><i class="fab fa-youtube" style="color: #eca328;"></i></a></li>
								<li><a href="https://www.instagram.com/dr_solankieyehospital/?hl=en"><i class="fab fa-instagram" style="color: #eca328;"></i></a></li>
								<li><a href="https://www.linkedin.com/company/106284134/admin/dashboard/"><i class="fab fa-linkedin" style="color: #eca328;"></i></a></li>
								<li><a href="https://x.com/Drsolankie10201"><i class="fab fa-twitter" style="color: #eca328;"></i></a></li>
								<li><a href="https://in.pinterest.com/drsolankieyehospital/"><i class="fab fa-pinterest" style="color: #eca328;"></i></a></li>
